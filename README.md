...
Exploring various metrics driving a portfolio, analyzing market sensitivities. This includes calculating Treasury Beta using multiple linear regression. The Rolling Sigmas (and Betas) calculates the 1 year rolling volatility and beta for 10 sectors of NYSE listed stocks, etc.
#
